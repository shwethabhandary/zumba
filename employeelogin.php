...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <section class="ftco-section" style="display: flex; background-color: #FFFBE6; align-items: center;justify-content: center;">
			<div class="container">
				<div class="row no-gutters ftco-services">
          <div id="DivLogin">
            <form action="authenticate.php" method="post" style="width:90%">
              <center><h3 style="color:green;"> Admin Authorization</h3></center>
